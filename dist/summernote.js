    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          url: 'Image URL',
          urlFromDb: 'Search media from database',
          search: 'Search',
          allSearch: 'List from database',
          remove: 'Remove Image'
        },
        link: {
          link: 'Link',
...
//                                        afterCommand($editable);  
    ...
    this.searchInDbChoice = function($editable, sUrl, filename) { 
        ...
        $('#content').remove();
    	$('.form-group').show();
        var $dbBtn = $('.note-dbAllSearch-btn');
  ...
  var Clipboard = function (handler) {
    ...
    var hPasteClipboardImage = function (event) {
      ...
      if (!clipboardData || !clipboardData.items || !clipboardData.items.length) {
        ...
        if (!callbacks.onImageUpload  || !callbacks.onImageSearch ) {
          return;
        }
  ...
  var EventHandler = function () {
    ...
    this.attach = function (layoutInfo, options) {
      ...
      layoutInfo.editable().data('callbacks', {
        ...
        onImageSearch: options.onImageSearch,
